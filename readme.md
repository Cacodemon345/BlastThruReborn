...
macOS:
Install the necessary dependencies listed here using Homebrew and run makeapple-macos.sh like this: `. ./makeapple-macos.sh`. Note that you will need to clone the RtMidi17 git repo inside this project's folder. Extracting assets from a macOS is possible.
